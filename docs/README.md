...
- `adr/0007-admin-resource-reservation-boundary-refactor.md`：后台、前端 API 与资源预约边界拆分基线
...
- `architecture/admin-resource-reservation-boundary-refactor.md`：后台、前端 API 与资源预约边界拆分蓝图
