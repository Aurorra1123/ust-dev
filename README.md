...
| 平均每文件复杂度总量 | `19.33` |
| 平均每函数复杂度 | `2.45` |
| Top 12 热点平均复杂度 | `22.00` |

### 分组均值

| 范围 | 文件数 | 函数数 | 平均每文件函数数 | 平均每文件复杂度总量 | 平均每函数复杂度 | 当前最大值 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `apps/web` | `103` | `807` | `7.83` | `18.92` | `2.42` | `38` |
| `apps/api` | `56` | `458` | `8.18` | `20.32` | `2.48` | `21` |
| `other` | `3` | `13` | `4.33` | `14.67` | `3.38` | `12` |
